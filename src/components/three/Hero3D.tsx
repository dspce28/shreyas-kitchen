...
export function HeroFallback() {
  return (
    <div className="pointer-events-none absolute inset-0 grid place-items-center" aria-hidden="true">
      {/* A tan thali seen at the same 45° as the WebGL version: an ellipse
      ...
      <div className="relative h-72 w-72">
        ...
        <div className="absolute bottom-12 left-1/2 h-28 w-64 -translate-x-1/2 rounded-[100%] bg-gradient-to-b from-tan/55 to-tan-700/35 ring-1 ring-tan/40" />
        <div className="absolute bottom-[5.5rem] left-[30%] h-7 w-16 rounded-[100%] bg-tan-700/45" />
        <div className="absolute bottom-[6rem] left-1/2 h-6 w-14 -translate-x-1/2 rounded-[100%] bg-tan-700/45" />
        <div className="absolute bottom-[5.5rem] right-[28%] h-7 w-16 rounded-[100%] bg-tan-700/45" />
