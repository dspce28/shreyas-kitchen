...
export function PreviewBanner() {
  return (
    <div className="mx-auto mt-6 max-w-3xl px-4 sm:px-6">
      <div className="glass-brass flex items-start gap-3 rounded-2xl px-4 py-3.5">
        <Database size={17} className="mt-0.5 shrink-0 text-brass-300" aria-hidden />
        <div className="text-sm">
          <p className="font-medium text-brass-300">Preview mode</p>
          <p className="mt-0.5 leading-relaxed text-cream-dim">
            Showing the printed menu. Connect Supabase and run{" "}
            <code className="rounded bg-black/40 px-1.5 py-0.5 text-xs text-brass-300">
              npm run seed
            </code>{" "}
